...
<Steps>
  ...
  <Step title="Enter your Summate inbox address">
    ...
    You should have received this during onboarding. If you haven't, visit [your inbox page](https://summate.io/inbox) to find it.
  ...
  <Step title="Find the verification email">
    1. Navigate to [your Summate inbox](https://summate.io/inbox)
