...
<AccordionGroup>
  ...
  <Accordion title="Already have newsletters via email" icon="envelope">
    If you're already receiving Substack newsletters via [email forwarding](/guides/auto-forwarding), you don't need to import them as RSS sources. You can add them to an Email block instead.
  </Accordion>
</AccordionGroup>
