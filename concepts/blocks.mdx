...
**Not Supported:** Podcast feeds or any RSS feeds that link directly to media files (.mp3, .mp4, etc.) are not supported and will cause digest generation failures.
</Warning>
