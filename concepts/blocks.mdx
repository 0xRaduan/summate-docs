...
- Each email is summarized with a TLDR and key takeaways (learn about [AI summarization](/concepts/ai-features))
...
- Each video is summarized with key takeaways linked to relevant timestamps (learn about [AI summarization](/concepts/ai-features))
...
- Each article is summarized with a TLDR and key takeaways (learn about [AI summarization](/concepts/ai-features))
...
<CardGroup cols={2}>
  ...
  <Card title="Custom Instructions" icon="wand-magic-sparkles" href="/concepts/ai-features#customization-levels">
...
Learn more about customizing AI summaries in our [AI Features guide](/concepts/ai-features).
...
<CardGroup cols={2}>
  ...
  <Card title="Use Custom Instructions" icon="wand-magic-sparkles" href="/concepts/ai-features#customization-levels">
...
<CardGroup cols={3}>
  ...
  <Card title="AI Customization" icon="sparkles" href="/concepts/ai-features">
