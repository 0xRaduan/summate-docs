...
<Frame caption="Choose from Email, YouTube, or RSS block types to add sources">
  <img src="/images/sources/sources-overview.png" alt="Overview of different source types in Summate" />
</Frame>
...
<Frame caption="Manage approved and blocked newsletter senders in your Inbox">
  <img src="/images/sources/email-sources.png" alt="Email sources in the Inbox showing active and blocked senders" />
</Frame>

**How to add:**

1. Set up your [Summate Inbox](/concepts/inbox)
2. Forward newsletters to your inbox (see our [auto-forwarding guide](/guides/auto-forwarding/overview))
...
<Frame caption="Import your YouTube subscriptions or add channels manually">
  <img src="/images/sources/youtube-sources.png" alt="Adding YouTube channels by importing subscriptions or pasting URLs" />
</Frame>
...
<Frame caption="Import Substack newsletters or add RSS feeds by URL">
  <img src="/images/sources/rss-sources.png" alt="Adding RSS feeds by entering website URLs" />
</Frame>
