...
<Steps>
  <Step title="Sign Up & Complete Onboarding">
    Go to [summate.io](https://summate.io?ref=docs.summate.io) and click "Start free trial". During onboarding:
  ...
  <Step title="Customize Your Digests">
    ...
    <Tabs>
      <Tab title="Email Block">
        ...
        2. **Forward newsletters** to your inbox ([setup guide](/guides/auto-forwarding/overview))
