...
Not at the moment, but this is a feature we have in mind and might add in the future. Please [vote for it on our roadmap](https://summate.io/roadmap?ref=docs.summate.io) if this is important to you!
...
- **Email newsletters** - Follow our [auto-forwarding guide](/guides/auto-forwarding/overview) to set up automatic forwarding
...
**Recommendation:** If you're subscribed to paid Substacks, set up your [Inbox](/concepts/inbox) and use the [auto-forwarding feature](/guides/auto-forwarding/overview) instead. This way, you'll get the full content of paid newsletters.
...
First, check if your digests appear in the [Issues tab](https://summate.io/v2/issues?ref=docs.summate.io). If they're there, we're generating them successfully but they're not being delivered to your inbox.
...
- **Network rejection** - Your email provider may be blocking forwarding. If you're using Outlook/Microsoft 365, see our [auto-forwarding guide](/guides/auto-forwarding/outlook) for details on enabling external forwarding.
